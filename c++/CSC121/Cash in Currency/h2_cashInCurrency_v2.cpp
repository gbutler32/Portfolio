...
==================================================================================
	...
	Modified:	10/7/2014 by Gary Butler
...
int reset(int i_hundred, int i_twenty, int i_ten, int i_five, int i_one, int quarters, int dimes, int nickels, int cents);
...
int reset(int i_hundred, int i_twenty, int i_ten, int i_five, int i_one, int quarters, int dimes, int nickels, int cents)
{
	...
	return i_hundred,i_twenty,i_ten;i_five;i_one;quarters;dimes;nickels;cents;
}
